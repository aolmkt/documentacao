  ...
  return (
    <section className="py-16 md:py-24 px-4">
      <div className="container max-w-3xl text-center">
        <div className="bg-highlight/60 rounded-2xl p-8 md:p-12 border border-highlight">
          ...
          <p className="text-left text-foreground/80 leading-relaxed mb-6">
            O modelo tradicional concentra toda a escrita no final do bimestre.
          </p>

          <p className="text-left text-foreground/80 mb-4">Isso gera:</p>
