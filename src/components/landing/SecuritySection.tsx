      ...
      <div className="container max-w-3xl">
        <div className="bg-card rounded-xl p-6 md:p-8 border border-border/60 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl md:text-[1.75rem] font-bold text-foreground uppercase leading-[1.2]">
          ...
          <ul className="space-y-2.5 mb-6">
            {items.map((item, index) => (
              <li
                key={index}
                className="flex items-start gap-3 text-foreground/80 text-base leading-[1.7]"
              >
          ...
          <div className="bg-lavanda rounded-lg p-4">
            ...
            <p className="text-base text-foreground font-medium mt-1.5">
